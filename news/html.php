...
<body class="body">
    ...
    <div style="background-color: rgba(12,78,45,0.7);">
   <br>
        ...
        <div id="header">
                ...
                <center>
                    <table>
                        <thead class="">
                            ...
                            <th id="pad" class="btn btn-success">
                                <a href="admin.php" target="blank" style="text-decoration: none; color: aliceblue;">
                                    User </a>
                            </th>
                        </thead>
                    </table>
            ...
            <div id="right-side">
                ...
                <form action="" method="post">
                    <input type="text" id="right-side" name="text" id="search" placeholder="Search by catagory"
                        class="hover" />
                ...
                if (isset($_REQUEST['search'])) {
                    $text = $_REQUEST['text'];
                    $select = "SELECT * FROM `add_cata` WHERE `Catagory` LIKE '% $text%' ";
