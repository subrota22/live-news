...
<head>
    ...
    <title> Data page of category by search  </title>
</head>
<body style="  background-color:rgba(17, 93, 235, 0.849);  padding:23px; text-align-center;">
<br><br>
<center>
<form action="" method="POST">
    <input type="text" name="text" id="" placeholder="Search by category name" style="height: 40px;"/>
...
$query = mysqli_query($con,$select);
  ...
  if(isset($_REQUEST['updated'])){
    ...
    $de_qu = "DELETE FROM add_cata  WHERE ID IN ($re_del)";
